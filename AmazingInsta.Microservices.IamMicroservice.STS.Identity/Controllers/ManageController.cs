...
using AmazingInsta.Microservices.IamMicroservice.STS.Identity.ViewModels.Manage;

namespace AmazingInsta.Microservices.IamMicroservice.STS.Identity.Controllers
{    
    [Authorize]
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("AmazingInsta.Microservices.IamMicroservice.STS.Identity"),
