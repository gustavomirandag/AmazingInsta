...
using SendGrid;
using AmazingInsta.Microservices.IamMicroservice.Shared.Configuration.Email;
using AmazingInsta.Microservices.IamMicroservice.Shared.Email;
using AmazingInsta.Microservices.IamMicroservice.STS.Identity.Configuration;
using AmazingInsta.Microservices.IamMicroservice.STS.Identity.Configuration.ApplicationParts;
...
using AmazingInsta.Microservices.IamMicroservice.STS.Identity.Helpers.Localization;
using System.Linq;
...
using AmazingInsta.Microservices.IamMicroservice.Shared.Authentication;
