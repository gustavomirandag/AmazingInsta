...
using AmazingInsta.Microservices.IamMicroservice.Admin.Api.Configuration.Authorization;
using AmazingInsta.Microservices.IamMicroservice.Admin.Api.ExceptionHandling;
using AmazingInsta.Microservices.IamMicroservice.Admin.Api.Helpers;
using AmazingInsta.Microservices.IamMicroservice.Admin.Api.Mappers;
using AmazingInsta.Microservices.IamMicroservice.Admin.Api.Resources;
...
using AmazingInsta.Microservices.IamMicroservice.Shared.Dtos;
using AmazingInsta.Microservices.IamMicroservice.Shared.Dtos.Identity;
using AmazingInsta.Microservices.IamMicroservice.Shared.Helpers;

namespace AmazingInsta.Microservices.IamMicroservice.Admin.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDataProtection()
                .SetApplicationName("AmazingInsta.Microservices.IamMicroservice")
